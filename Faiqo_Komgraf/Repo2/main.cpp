...
void perkalianSkalar(int m1[2][2], int m2[2][2])
{
    ...
    cout << "Hasil dari perkalian skalar matriks 1" << endl;
    for (i = 0; i < 2; i++){
        for (j = 0; j < 2; j++)
        {
            cout << h1[i][j] << " ";
    ...
    cout << endl;
    cout << "Hasil dari perkalian skalar matriks 2" << endl;
    for (i = 0; i < 2; i++){
        for (j = 0; j < 2; j++)
        {
            cout << h2[i][j] << " ";
...
int main()
{
    ...
    for (i = 0; i < 2; i++)
    {
        for (j = 0; j < 2; j++)
        {
            cout << "Masuk nilai untuk matriks 1 baris [" << i + 1 << "] dan kolom [" << j + 1 << "]" << endl;
            cin >> m1[i][j];
        }
    }
    ...
    for (i = 0; i < 2; i++)
    {
        for (j = 0; j < 2; j++)
        {
            cout << "Masuk nilai untuk matriks 2 baris [" << i + 1 << "] dan kolom [" << j + 1 << "]" << endl;
            cin >> m2[i][j];
        }
    }
    cout << endl;
    ...
    cout <<"Hasil dari perkalian antar matriks :" << endl;
    perkalianAntarMatriks(m1, m2);
    cout << endl;

    cout <<"Hasil dari perkalian skalar matriks :" << endl;
